    ...
    def generate(self, size):
        ...
        for layout in layouts:
            ...
            for bbox, align in layout:
                ...
                if align == "left":
                    text_layer.right = x + w  # Adjust for RTL text
                if align == "right":
        ...
        # Adjust text layers to align from right to left and then top to bottom
        for text_layer in text_layers:
            text_layer.right = width - (text_layer.left - layout_bbox[0])  # Adjust for RTL alignment
            text_layer.left = text_layer.right - text_layer.width  # Ensure proper RTL bounding
